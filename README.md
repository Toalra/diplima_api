<h1>Проект по автотестировани api для сайта <img src="https://github.com/Toalra/diplima_api/blob/master/src/test/resources/media/logs/logo.png" wight="35" height="35"/> </h1>
<h2>Содержание</h2>
